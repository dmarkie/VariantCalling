...
if [ -f ${PROJECT_PATH}/done/genotype/${CONTIG}_gen.vcf.gz.done ]; then
	...
	# --allow-old-rms-mapping-quality-annotation-data ### this has been added so that GATK v4.1.3 will process alignments done with v3.8 - these use a RAW_MQ score which is no longer natively recognised by 4.1.3
